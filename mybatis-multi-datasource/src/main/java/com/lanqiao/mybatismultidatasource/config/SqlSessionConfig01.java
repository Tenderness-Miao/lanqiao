 ...
 */
@Configuration
@MapperScan(basePackages = "com.lanqiao.mybatismultidatasource.dao.shiyanlou01", sqlSessionFactoryRef = "sqlSessionFactory01")
    ...
    public SqlSessionFactory getSqlSessionFactory(
        ...
        try {
            ...
            factoryBean.setMapperLocations(
                    // 设置Mybatis的xml文件位置
                    new PathMatchingResourcePatternResolver().getResources("classpath:mapper/shiyanlou01/*.xml"));
